...
let CalendarEventService = class CalendarEventService {
    ...
    async update(id, CalendarEvent) {
        return await this.calendarEventModel.findOneAndUpdate({ id }, CalendarEvent, {
            new: true,
        });
    }
    async delete(id) {
...
CalendarEventService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, mongoose_1.InjectModel)(CalendarEvent_schema_1.CalendarEvent.name)),
    __metadata("design:paramtypes", [mongoose_2.Model])
], CalendarEventService);
exports.CalendarEventService = CalendarEventService;
//# sourceMappingURL=calendarevent.service.js.map